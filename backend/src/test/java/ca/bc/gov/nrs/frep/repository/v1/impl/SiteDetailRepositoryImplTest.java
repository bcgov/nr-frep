...
class SiteDetailRepositoryImplTest {
  ...
  private SiteDetailRepositoryImpl repository;

  @BeforeEach
  void setUp() throws Exception {
    repository = new SiteDetailRepositoryImpl(jdbcTemplate);
  ...
  void fromResourceStructParsesLegacyObjectAttributes() throws Exception {
    ...
    SiteResourceRow row = SiteDetailRepositoryImpl.fromResourceStruct(struct);
