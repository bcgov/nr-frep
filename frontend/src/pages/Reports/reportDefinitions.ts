...
export const GENERATABLE_REPORTS: GeneratableReport[] = [
  {
    ...
    title: 'Stand Level Retention — Block Table extract',
    summary: 'Opening/block-level Stand Level Retention checklist data.',
  ...
  },
  {
    ...
    title: 'Stand Level Retention — Stratum Table extract',
    summary: 'Stratum-summary Stand Level Retention data.',
    availableFormats: ['csv'],
    fields: BIODIVERSITY_EXTRACT_FIELDS,
    layout: BIODIVERSITY_EXTRACT_LAYOUT,
  },
  {
    ...
    title: 'Stand Level Retention — Plot Table extract',
    summary: 'Plot-level Stand Level Retention data.',
    availableFormats: ['csv'],
    fields: BIODIVERSITY_EXTRACT_FIELDS,
    layout: BIODIVERSITY_EXTRACT_LAYOUT,
  },
  {
    ...
    title: 'Stand Level Retention — Stand Table extract',
    summary: 'Stand-table (tree) Stand Level Retention data.',
    availableFormats: ['csv'],
    fields: BIODIVERSITY_EXTRACT_FIELDS,
    layout: BIODIVERSITY_EXTRACT_LAYOUT,
  },
  {
    ...
    title: 'Stand Level Retention — Coarse Woody Debris extract',
    summary: 'CWD-table Stand Level Retention data.',
    availableFormats: ['csv'],
    fields: BIODIVERSITY_EXTRACT_FIELDS,
    layout: BIODIVERSITY_EXTRACT_LAYOUT,
  },
