...
import ca.bc.gov.nrs.frep.repository.frep.AbstractFrepRepository;
...
@Repository
@Profile("oracle")
public class ChrChecklistRepository extends AbstractFrepRepository {

  private static final String PACKAGE = "FREP_TOMBSTONE";

  public ChrChecklistRepository(@Qualifier("oracleJdbcTemplate") JdbcTemplate jdbcTemplate) {
    super(jdbcTemplate);
  }
