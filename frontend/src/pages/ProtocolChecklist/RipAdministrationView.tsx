...
// Fields the user edits in this form. Team add/remove hit the server immediately and return the
// whole administration record; without this, that response would clobber these still-unsaved edits
// (e.g. the People-on-block value the user just typed). So on a team update we keep the in-progress
// values for these fields and take everything else (team list, lead, revision counts) from the
// server.
