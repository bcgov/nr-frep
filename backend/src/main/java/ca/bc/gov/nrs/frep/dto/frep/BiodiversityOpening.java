 ...
 *
 * <p>Field names/order mirror the {@code FREP_210_BIO_OPENING.SAVE} parameters. All values are
 * Strings (the legacy DC posts indicators as {@code "Y"}/{@code "N"} and codes as-is).
